...
import 'package:popcorn_flix/components/youtubeTrailerPlayer.dart';
...
class _MovieScreenState extends State<MovieScreen>{
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: [
            ...
            children: [
              ShaderMask(
                shaderCallback: (rect) {
                  ...
                  ).createShader(Rect.fromLTRB(rect.right, rect.left, rect.width, rect.height));
                },
                blendMode: isWatchingTrailer==true? BlendMode.clear:BlendMode.dstATop,
                child: Container(
                  height: 450,
              ...
              isWatchingTrailer==true? Positioned(top: 100 ,child: TrailerPlayer(id: movieTrailerId)):Positioned(
                top: 100,
                height: 350,
                child: Padding(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () {
                              ...
                              RequestHelper().getMovieTrailer(widget.movie.id).then((value){
                                setState(() {
                                  movieTrailerId = getTrailerId(value);
          ...
          isWatchingTrailer==false? Padding(
  ...
  String getTrailerId(dynamic value) {
    print(value);
    String  url = value['results']['trailer'];
